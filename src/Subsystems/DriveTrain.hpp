...
private:
    ...
    CANTalon m_leftFront{k_leftDriveMasterID};
    CANTalon m_leftRear{k_leftDriveSlaveID};
    CANTalonGroup m_leftGrbx{m_leftFront, m_leftRear};

    // Right gearbox used in position PID
    CANTalon m_rightFront{k_rightDriveMasterID};
    CANTalon m_rightRear{k_rightDriveSlaveID};
