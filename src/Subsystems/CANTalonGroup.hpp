...
using CTRE::MotorControl::CAN::TalonSRX;
...
public:
    ...
    void SetFeedbackDevice(TalonSRX::FeedbackDevice device);
...
private:
    ...
    // Feedback device
    TalonSRX::FeedbackDevice m_feedbackDevice = TalonSRX::QuadEncoder;
