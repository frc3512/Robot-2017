...
bool DriveTrain::PosAtReference() {
    return std::abs(GetPosReference() - GetPosition()) < 0.001;
}

bool DriveTrain::AngleAtReference() {
    return std::abs(GetAngleReference() - GetAngle()) < 0.001;
}
...
void DriveTrain::Debug() {
	...
	// Gyro Values
	std::cout << "Gyro Rate: " << m_gyro.GetRate() << std::endl;
    ...
    std::cout << "Left Position: " << m_leftGrbx.GetPosition() << std::endl;
    std::cout << "Right Position: " << m_rightGrbx.GetPosition() << std::endl;
    ...
    // References
    std::cout << "Position Reference: " << m_posRef.Get() << std::endl;
    std::cout << "Angle Reference: " << m_angleRef.Get() << std::endl;
}
