...
void ADXRS450_Gyro::Calibrate() {
    ...
    m_accumCenter = static_cast<int>(m_spi.GetAccumulatorAverage());
    m_spi.SetAccumulatorCenter(m_accumCenter);
    m_spi.ResetAccumulator();
}
...
/**
 * Set the rate bias of the gyro
 *
 *
 */
void ADXRS450_Gyro::SetRateBias(double bias) {
    m_spi.SetAccumulatorCenter(m_accumCenter +
                               static_cast<int>(bias / kDegreePerSecondPerLSB));
}
